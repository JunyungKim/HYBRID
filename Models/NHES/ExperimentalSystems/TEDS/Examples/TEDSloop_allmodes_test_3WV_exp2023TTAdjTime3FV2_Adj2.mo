...
model TEDSloop_allmodes_test_3WV_exp2023TTAdjTime3FV2_Adj2
  "Test designed to ensure the TEDS loop can operate in all modes."

  parameter Real FV_opening=0.9;
...
equation
  ...
  connect(PV_052.port_a, FM_202.port_b) annotation (Line(points={{182,-122},{
          182,-118},{154,-118},{154,-112}}, color={0,127,255}));
  connect(PV_052.port_b, pipe3.port_a) annotation (Line(points={{182,-134},{182,
          -142},{176,-142}},
                      color={0,127,255}));
  ...
  connect(Heater_BOP_Demand1.y, PV_009.opening) annotation (Line(points={{93.1,
          -177},{93.1,-176},{100,-176},{100,-148.8},{92,-148.8}}, color={0,0,
          127}));
  ...
  connect(MassFlow_Control1.y, PV_012.opening) annotation (Line(points={{-21.4,
          -188},{46,-188},{46,-182},{51.2,-182}}, color={0,0,127}));
  ...
  connect(TC_006.port_a, nonLinear_Break2.port_a) annotation (Line(points={{28,
          -145},{28,-146},{22,-146}}, color={0,127,255}));
  ...
  connect(Glycol_HX.port_a_shell, TC_004.port_a) annotation (Line(points={{100,
          -202.1},{124,-202.1},{124,-202}}, color={0,127,255}));
  ...
  connect(TC_005.port_a, TC_006.port_b) annotation (Line(points={{56,-150},{56,
          -145},{52,-145}}, color={0,127,255}));
  connect(Chiller_Mass_flow_T66.port_b, TC_004.port_b) annotation (Line(points=
          {{125,-173},{126,-173},{126,-176},{124,-176},{124,-182}}, color={0,
          127,255}));
  ...
  connect(m_thot.port_a, T_discharge_outlet.port_a) annotation (Line(points={{
          84,42},{84,44},{116,44},{116,42},{142,42},{142,-2},{148,-2},{148,-3},
          {154,-3}}, color={0,127,255}));
  ...
  connect(PV_051.port_a, T_ch_o.port_b) annotation (Line(points={{80,-110},{80,
          -100},{134,-100},{134,-51},{154,-51}}, color={0,127,255}));
  ...
  connect(Conversion_lpm.y, FM_1.u1) annotation (Line(points={{-50.9,-49},{
          -50.9,-50},{-45,-50}}, color={0,0,127}));
  connect(Flow.y[1], FM_1.u2) annotation (Line(points={{-61.3,-73},{-52,-73},{
          -52,-56},{-45,-56}}, color={0,0,127}));
  annotation (
...
end TEDSloop_allmodes_test_3WV_exp2023TTAdjTime3FV2_Adj2;
