...
model TEDSloop_allmodes_test_3WV_exp2023TTAdjTime3FV2_Adj2_1
  ...
  Modelica.Fluid.Sources.MassFlowSource_T Chiller_Mass_Flow(
    ...
    T=280.15,
    nPorts=1)
    annotation (Placement(transformation(extent={{30,-254},{50,-234}})));
  ...
  TRANSFORM.HeatExchangers.GenericDistributed_HX Glycol_HX(
    ...
    redeclare model HeatTransfer_shell =
        TRANSFORM.Fluid.ClosureRelations.HeatTransfer.Models.DistributedPipe_1D_MultiTransferSurface.Nus_DittusBoelter_Simple
        (CF=2.0))
    annotation (Placement(transformation(extent={{69,-254},{100,-224}})));
  ...
  TRANSFORM.Controls.LimPID MassFlow_Control1(
    ...
    initType=Modelica.Blocks.Types.Init.InitialOutput,
    y_start=0.5)
    annotation (Placement(transformation(extent={{-34,-182},{-22,-194}})));
  Modelica.Blocks.Sources.RealExpression Heater_BOP_Demand1(y=1 - PV_012.opening)
    annotation (Placement(transformation(extent={{70,-188},{92,-166}})));
  ...
  Modelica.Blocks.Sources.CombiTimeTable V3(table=[0,0.001; 2220,0; 2400,0; 9180,
        0; 9280,0; 10980,0; 11080,1; 14640,1; 14740,0; 15740,0],
                                                               startTime=0)
  ...
  Modelica.Blocks.Sources.CombiTimeTable THXout(table=[0,400; 2220,400; 2400,
    ...
    annotation (Placement(transformation(extent={{-112,-182},{-98,-168}})));
  ...
  Modelica.Blocks.Sources.RealExpression Q_GHX(y=Glycol_HX.port_a_shell.m_flow*
    ...
    annotation (Placement(transformation(extent={{72,-280},{94,-258}})));
  ...
  Modelica.Fluid.Pipes.DynamicPipe pipe5(
    ...
    redeclare model FlowModel =
        Modelica.Fluid.Pipes.BaseClasses.FlowModels.NominalLaminarFlow (
          dp_nominal=600, m_flow_nominal=0.689))
    annotation (Placement(transformation(extent={{106,40},{92,54}})));
  ...
  Modelica.Blocks.Sources.RealExpression Conversion_lpm(y=1/15850.323140625002*1000
        *60)
    annotation (Placement(transformation(extent={{-74,-60},{-52,-38}})));
  ...
  TRANSFORM.Fluid.Valves.ValveLinear PV_008(
    ...
    m_flow_nominal=0.840) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={198,-158})));
  Modelica.Blocks.Sources.Constant const5(k=1)           annotation (Placement(
        transformation(
        extent={{4,-4},{-4,4}},
        rotation=0,
        origin={218,-158})));
...
equation
  ...
  connect(TC_003.port_b, tank1.port_a) annotation (Line(points={{2,46},{-3.6,46},
  ...
  connect(PV_052.port_a, FM_202.port_b) annotation (Line(points={{182,-122},{182,
  ...
  connect(Chiller_Mass_Flow.ports[1], Glycol_HX.port_a_tube) annotation (Line(
        points={{50,-244},{50,-239},{69,-239}},           color={0,127,255}));
  connect(Glycol_HX.port_b_tube, Ethylene_glycol_exit_temperature.port_a)
    annotation (Line(points={{100,-239},{100,-240},{140,-240}},           color=
         {0,127,255}));
  ...
  connect(TC_003.T, Chromolox_Heater_Control.u_m) annotation (Line(points={{-10,
  ...
  connect(sensor_m_flow3.port_a, T_discharge_outlet.port_b)
    annotation (Line(points={{154,30},{154,25}}, color={0,127,255}));
  ...
  connect(actuatorSubBus.T_discharge_outlet, T_discharge_outlet.T) annotation (
      Line(
      points={{-31,106},{202,106},{202,13},{158.68,13}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(actuatorSubBus.Total_Mass_Flow_System, Chiller_Mass_flow_T66.m_flow)
    annotation (Line(
      points={{-31,106},{240,106},{240,-199.5},{128.28,-199.5}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(T_chiller_after.port_b, pipe3.port_a) annotation (Line(points={{227,-78},
          {226,-78},{226,-142},{214,-142}},
                                       color={0,127,255}));
  ...
  connect(Heater_BOP_Demand.y, pump.in_p) annotation (Line(points={{-30.9,-169},
          {-30.9,-170},{6,-170},{6,-151.84},{-8,-151.84}},
                                 color={0,0,127}));
  connect(const2.y, Chiller_Mass_Flow.m_flow_in) annotation (Line(points={{0.4,-238},
          {0.4,-236},{30,-236}}, color={0,0,127}));
  connect(Heater_BOP_Demand1.y, PV_009.opening) annotation (Line(points={{93.1,-177},
          {93.1,-176},{100,-176},{100,-148.8},{92,-148.8}}, color={0,0,127}));
  connect(TC_006.T, MassFlow_Control1.u_m) annotation (Line(points={{40,-149.68},
          {40,-176},{-28,-176},{-28,-180.8}}, color={0,0,127}));
  connect(MassFlow_Control1.y, PV_012.opening) annotation (Line(points={{-21.4,-188},
          {46,-188},{46,-182},{51.2,-182}}, color={0,0,127}));
  connect(Glycol_HX.port_b_shell, nonLinear_Break.port_a) annotation (Line(
        points={{69,-232.1},{56,-232.1},{56,-232}}, color={0,127,255}));
  connect(nonLinear_Break.port_b, PV_012.port_a)
    annotation (Line(points={{56,-220},{56,-188}}, color={0,127,255}));
  connect(TC_006.port_a, nonLinear_Break2.port_a) annotation (Line(points={{28,-145},
          {28,-146},{22,-146}}, color={0,127,255}));
  ...
  connect(FM_001.m_flow, product1.u2) annotation (Line(points={{-33,-143.12},{-34,
          -143.12},{-34,-114},{-140,-114},{-140,-120},{-160,-120},{-160,-114},{-155,
          -114}}, color={0,0,127}));
  ...
  connect(THXout.y[1], add.u1) annotation (Line(points={{-97.3,-175},{-97.3,
          -182},{-86,-182}},                       color={0,0,127}));
  connect(const3.y, add.u2) annotation (Line(points={{-105.6,-194},{-86,-194}},
                                 color={0,0,127}));
  connect(add.y, MassFlow_Control1.u_s) annotation (Line(points={{-63,-188},{
          -35.2,-188}},                                             color={0,0,
          127}));
  connect(FM_001_gpm.y, VolFlow_Control2.u_m) annotation (Line(points={{-115.5,-93},
  ...
  connect(V3.y[1], firstOrder5.u) annotation (Line(points={{148.7,165},{252,165},
          ...
          {0,0,127}));
  connect(PV_052.opening, V1.y[1]) annotation (Line(points={{186.8,-128},{258,
          -128},{258,178},{72,178},{72,165},{56.7,165}},
        color={0,0,127}));
  ...
  connect(Glycol_HX.port_a_shell, TC_004.port_a) annotation (Line(points={{100,-232.1},
          {124,-232.1},{124,-232}}, color={0,127,255}));
  connect(PV_012.port_b, TC_005.port_b)
    annotation (Line(points={{56,-176},{56,-170}}, color={0,127,255}));
  connect(TC_005.port_a, TC_006.port_b) annotation (Line(points={{56,-150},{56,-145},
          {52,-145}}, color={0,127,255}));
  ...
  connect(pipe1.port_a, nonLinear_Break1.port_b) annotation (Line(points={{16,
          -122},{-2,-122},{-2,-126},{-10,-126}}, color={0,127,255}));
  ...
  connect(Conversion_lpm.y, FM_1.u1) annotation (Line(points={{-50.9,-49},{-50.9,
          -50},{-45,-50}}, color={0,0,127}));
  connect(Flow.y[1], FM_1.u2) annotation (Line(points={{-61.3,-73},{-52,-73},{-52,
          -56},{-45,-56}}, color={0,0,127}));
  connect(const5.y,PV_008. opening)
    annotation (Line(points={{213.6,-158},{202.8,-158}}, color={0,0,127}));
  connect(pipe3.port_b, nonLinear_Break3.port_a)
    annotation (Line(points={{202,-142},{118,-142}}, color={0,127,255}));
  connect(PV_008.port_a, pipe3.port_b) annotation (Line(points={{198,-152},{198,
          -142},{202,-142}}, color={0,127,255}));
  connect(pipe8.port_b, Chiller_Mass_flow_T66.port_a) annotation (Line(points={{
          142,-180},{124.5,-180},{124.5,-190}}, color={0,127,255}));
  connect(PV_052.port_b, pipe8.port_a) annotation (Line(points={{182,-134},{182,
          -180},{154,-180}}, color={0,127,255}));
  connect(PV_008.port_b, pipe8.port_a) annotation (Line(points={{198,-164},{198,
          -180},{154,-180}}, color={0,127,255}));
  connect(PV_051.port_a, pipe9.port_a) annotation (Line(points={{80,-110},{80,-98},
          {112,-98}}, color={0,127,255}));
  connect(pipe9.port_b, T_ch_o.port_b) annotation (Line(points={{124,-98},{136,-98},
          {136,-50},{154,-50},{154,-51}}, color={0,127,255}));
  connect(pipe5.port_b, m_thot.port_a)
    annotation (Line(points={{92,47},{84,47},{84,42}}, color={0,127,255}));
  connect(PV_049.port_b, pipe5.port_a) annotation (Line(points={{84,60},{84,56},
          {114,56},{114,47},{106,47}}, color={0,127,255}));
  connect(T_discharge_outlet.port_a, pipe10.port_b) annotation (Line(points={{154,
          1},{154,0},{138,0},{138,46},{134,46}}, color={0,127,255}));
  connect(pipe10.port_a, pipe5.port_a) annotation (Line(points={{122,46},{114,46},
          {114,47},{106,47}}, color={0,127,255}));
  annotation (
...
end TEDSloop_allmodes_test_3WV_exp2023TTAdjTime3FV2_Adj2_1;
