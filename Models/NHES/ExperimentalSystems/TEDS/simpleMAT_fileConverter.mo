...
input String filename="FV_opening_100.mat" "File to be converted" annotation (Dialog(__Dymola_loadSelector(filter="Matlab files (*.mat)",
...
input String outputFilename="FV_opening_100_converted.mat";
