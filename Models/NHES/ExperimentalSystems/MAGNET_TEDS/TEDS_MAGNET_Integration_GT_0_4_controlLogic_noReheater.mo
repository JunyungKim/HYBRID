...
model TEDS_MAGNET_Integration_GT_0_4_controlLogic_noReheater
...
public
  ...
  Magnet_TEDS.MAGNET_TEDS_ControlSystem.Control_System_Therminol_4_element_all_modes_MAGNET_GT_dyn_0_4_valve_cv_TEDS_controlLogic_Changed
    control_System_Therminol_4_element_all_modes_MAGNET_GT_dyn_0_4_charNdischar_ControlLogic_changed(
    redeclare package Medium =
        TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C,
    T_hot_design=598.15,
...
equation
  ...
  connect(sensorSubBus.heater_BOP_massflow, BOP_Mass_flow.m_flow) annotation (
      Line(
      points={{303,-22},{574,-22},{574,-48},{506,-48},{506,-48.4},{440,-48.4}},
      color={238,46,47},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(sensorSubBus,
    control_System_Therminol_4_element_all_modes_MAGNET_GT_dyn_0_4_charNdischar_ControlLogic_changed.sensorSubBus)
    annotation (Line(
  ...
  connect(actuatorSubBus,
    control_System_Therminol_4_element_all_modes_MAGNET_GT_dyn_0_4_charNdischar_ControlLogic_changed.actuatorSubBus)
    annotation (Line(
...
end TEDS_MAGNET_Integration_GT_0_4_controlLogic_noReheater;
