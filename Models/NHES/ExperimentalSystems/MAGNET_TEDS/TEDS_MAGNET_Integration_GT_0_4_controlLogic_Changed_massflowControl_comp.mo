...
model TEDS_MAGNET_Integration_GT_0_4_controlLogic_Changed_massflowControl_comp
...
public
  ...
  Magnet_TEDS.MAGNET_TEDS_ControlSystem.Control_System_Therminol_4_element_all_modes_MAGNET_GT_dyn_0_4_massflowControl
...
equation
  ...
  connect(sensorSubBus.heater_BOP_massflow, BOP_Mass_flow.m_flow) annotation (
      Line(
      points={{303,-22},{440, -22}, {940,-22},{940,-48.4}, {440, -48.4}},
      color={238,46,47},
      pattern=LinePattern.Dash,
      thickness=0.5));
...
end TEDS_MAGNET_Integration_GT_0_4_controlLogic_Changed_massflowControl_comp;
