...
model TEDS_MAGNET_Integration_GT_0_4_controlLogic_reheaterInstalled
...
equation
  ...
  connect(springBallValve.port_b,boundary5. ports[1])
    annotation (Line(points={{-192,34},{-192,40},{-152,40}},
                                                          color={0,127,255}));
  connect(mflow_GT_rp.port_b, pT_TEDS_rp.port_b) annotation (Line(points={{-74,-58},
          {-74,-130},{-1.77636e-15,-130},{-1.77636e-15,-122}},    color={0,127,
          255}));
  ...
  connect(sensorSubBus.Total_Mass_Flow_System, Chiller_Mass_flow_T66.m_flow)
    annotation (Line(
      points={{303,-22},{574,-22},{574,-286},{453,-286},{453,-273.6}},
      color={238,46,47},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(sensorSubBus.heater_BOP_massflow, BOP_Mass_flow.m_flow) annotation (
      Line(
      points={{303,-22},{574,-22},{574,-50},{508,-50},{508,-48.4},{440,-48.4}},
      color={238,46,47},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(MAGNET_TEDS_simpleHX1.port_b1, valve_TEDS_rp.port_a) annotation (Line(
        points={{246,-78},{0,-78},{0,-80},{4.44089e-16,-80},{4.44089e-16,-84}},
        color={0,127,255}));
  ...
  connect(sensorSubBus.MAGNET_flow, m_flow_vc_TEDS.m_flow) annotation (Line(
      points={{303,-22},{-88,-22},{-88,-90},{-67.6,-90}},
      color={238,46,47},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(actuatorSubBus.MAGNET_valve_opening, valve_vc_TEDS.opening)
    annotation (Line(
      points={{335,-22},{-96,-22},{-96,-142},{-68.8,-142}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(pT_co_rp.port_b, Cooler1.port_a)
    annotation (Line(points={{-104,12},{-92,12}}, color={0,127,255}));
  connect(Cooler1.port_b, mflow_GT_rp.port_a)
    annotation (Line(points={{-80,12},{-74,12},{-74,-38}}, color={0,127,255}));
  connect(boundary6.port, Cooler1.heatPort)
    annotation (Line(points={{-74,38},{-86,38},{-86,18}}, color={191,0,0}));
...
end TEDS_MAGNET_Integration_GT_0_4_controlLogic_reheaterInstalled;
