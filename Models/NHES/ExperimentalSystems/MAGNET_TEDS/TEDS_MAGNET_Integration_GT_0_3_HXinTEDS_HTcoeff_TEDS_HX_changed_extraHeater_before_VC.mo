...
model
  TEDS_MAGNET_Integration_GT_0_3_HXinTEDS_HTcoeff_TEDS_HX_changed_extraHeater_before_VC
...
equation
  ...
  connect(Chiller_Mass_Flow1.ports[1], TEDS_HX.port_a_tube) annotation (Line(
        points={{678,-178},{568,-178},{568,-170.5},{568.5,-170.5}}, color={0,
          127,255}));
  connect(pT_pipe_vc.port_b, Cooler1.port_b)
    annotation (Line(points={{-68,-200},{-82,-200}}, color={0,127,255}));
  connect(Cooler1.port_a, vc.port_a) annotation (Line(points={{-94,-200},{-146,
          -200},{-146,-198}}, color={0,127,255}));
  connect(boundary6.port, Cooler1.heatPort) annotation (Line(points={{-114,-218},
          {-88,-218},{-88,-206}}, color={191,0,0}));
