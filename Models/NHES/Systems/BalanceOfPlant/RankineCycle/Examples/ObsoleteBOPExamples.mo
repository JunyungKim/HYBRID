...
package ObsoleteBOPExamples
  ...
  model Intermediate_Rankine_Cycle_Test_e
    ...
    extends Modelica.Icons.Example;
    NHES.Systems.BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle
      BOP(port_a_nominal(
        m_flow=493.7058,
        p=14000000,
  ...
  model Intermediate_Rankine_Cycle_Test_c
    ...
    NHES.Systems.BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_Control
      BOP(port_a_nominal(
        m_flow=493.7058,
        p=14000000,
        h=BOP.Medium.specificEnthalpy_pT(BOP.port_a_nominal.p, 591)),
  ...
  model Intermediate_Rankine_Cycle_Test_b
    import NHES;
    extends Modelica.Icons.Example;
    NHES.Systems.BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC
      BOP(port_a_nominal(
        m_flow=70,
        p=3500000,
        h=BOP.Medium.specificEnthalpy_pT(BOP.port_a_nominal.p, 591)),
