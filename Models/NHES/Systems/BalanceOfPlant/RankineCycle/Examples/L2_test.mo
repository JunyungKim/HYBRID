...
model L2_test
  ...
  Models.SteamTurbine_L2_OFWH pHTGR_BOPinit2_1(redeclare replaceable
      NHES.Systems.BalanceOfPlant.RankineCycle.ControlSystems.CS_L2 CS(
        redeclare NHES.Systems.BalanceOfPlant.RankineCycle.Data.Data_L2 data(
        Power_nom=40e6,
        HPT_p_in=12500000,
        p_dump=16000000,
        p_i=2500000,
      ...
      NHES.Systems.BalanceOfPlant.RankineCycle.Data.Data_L2 data(
      Power_nom=40e6,
      HPT_p_in=12500000,
      p_dump=16000000,
      p_i=2500000,
