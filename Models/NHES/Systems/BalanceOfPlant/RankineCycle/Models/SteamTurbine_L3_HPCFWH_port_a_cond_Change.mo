...
model SteamTurbine_L3_HPCFWH_port_a_cond_Change
...
equation
  ...
  connect(port_a_cond, pump.port_a) annotation (Line(points={{100,-42},{100,-64},
          {64,-64},{64,-60},{54,-60}}, color={0,127,255}));
...
end SteamTurbine_L3_HPCFWH_port_a_cond_Change;
