...
model SteamTurbine_L3_HTGR_v2_Fail1
  ...
  Fluid.Vessels.IdealCondenser Condenser(
    ...
    annotation (Placement(transformation(extent={{244,-78},{224,-58}})));
...
equation
  ...
  connect(sensor_m_flow1.port_b,Condenser. port_a)
    annotation (Line(points={{242,-26},{242,-58},{241,-58}},
                                                     color={0,127,255},
      thickness=0.5));
  ...
  connect(actuatorBus.Divert_Valve_Position, LPT2_Bypass.opening) annotation (
      Line(
      points={{30,100},{258,100},{258,-44},{174,-44}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(BypassFeedwaterHeater.Shell_out, LPT2_Bypass.port_a)
    annotation (Line(points={{28,-52},{164,-52}}, color={0,127,255}));
  connect(LPT2_Bypass.port_b, Condenser.port_a) annotation (Line(points={{184,
          -52},{242,-52},{242,-58},{241,-58}}, color={0,127,255}));
  connect(tee2.port_3, BypassFeedwaterHeater.Shell_in) annotation (Line(points=
          {{178,40},{178,-38},{0,-38},{0,-52},{8,-52}}, color={0,127,255}));
...
end SteamTurbine_L3_HTGR_v2_Fail1;
