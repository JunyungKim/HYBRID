...
model SteamTurbine_L1_boundaries_type3
  ...
  parameter SI.Pressure p_SteamTurbine = 140e7 "steam turbine inlet pressure";
  ...
  Modelica.Blocks.Sources.RealExpression SteamTurbinePressure(y=steamTurbine.p_a_start)
    annotation (Placement(transformation(extent={{-96,140},{-84,152}})));
equation
...
connect(boundary_m_flow_a3[i].ports[1], multiPort1.ports_b[i+2]);
  ...
  connect(valve_BV.port_a, header.port_b[1]) annotation (Line(points={{-80,0},{
          -100,0},{-100,39.5},{-104,39.5}},       color={0,127,255}));
  connect(valve_TCV.port_a, header.port_b[2]) annotation (Line(points={{-80,40},
          {-92,40},{-92,40.5},{-104,40.5}}, color={0,127,255}));
  ...
  connect(sensorBus.p_inlet_steamTurbine, SteamTurbinePressure.y) annotation (
      Line(
      points={{-29.9,100.1},{-29.9,124},{-60,124},{-60,146},{-83.4,146}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
...
end SteamTurbine_L1_boundaries_type3;
