...
model SteamTurbine_L3_HTGR_v2_Fail2
  ...
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance R_feedwater(R=1e5,
      redeclare package Medium = Modelica.Media.Water.StandardWater)
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=180,
        origin={186,-52})));
...
equation
  ...
  connect(BypassFeedwaterHeater.Shell_out, R_feedwater.port_a)
    annotation (Line(points={{28,-52},{179,-52}}, color={0,127,255}));
  connect(R_feedwater.port_b, Condenser.port_a) annotation (Line(points={{193,
...
end SteamTurbine_L3_HTGR_v2_Fail2;
