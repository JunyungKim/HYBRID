...
model SteamTurbine_L3_HTGR_v2_Fail3
  ...
  Fluid.Vessels.IdealCondenser Condenser(
    ...
    annotation (Placement(transformation(extent={{244,-80},{230,-66}})));
...
equation
  ...
  connect(sensor_m_flow1.port_b, volume2.port_a)
    annotation (Line(points={{242,-26},{242,-42}}, color={0,127,255}));
  connect(volume2.port_b, Condenser.port_a) annotation (Line(points={{242,-54},
          {242,-66},{241.9,-66}}, color={0,127,255}));
  connect(LPT2_Bypass1.port_b, volume2.port_a) annotation (Line(points={{172,
          -52},{208,-52},{208,-42},{242,-42}}, color={0,127,255}));
...
end SteamTurbine_L3_HTGR_v2_Fail3;
