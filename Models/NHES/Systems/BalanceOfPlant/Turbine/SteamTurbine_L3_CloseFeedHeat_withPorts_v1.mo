...
model SteamTurbine_L3_CloseFeedHeat_withPorts_v1
  ...
  Fluid.Vessels.IdealCondenser Condenser(
    ...
    annotation (Placement(transformation(extent={{246,-112},{226,-92}})));
  ...
  TRANSFORM.Fluid.Valves.ValveLinear LPT2_Bypass_1(
    redeclare package Medium = Modelica.Media.Water.StandardWater,
    dp_nominal=data.valve_LPT2_Bypass_dp_nominal,
    m_flow_nominal=data.valve_LPT2_Bypass_mflow) annotation (Placement(
        transformation(
        extent={{10,10},{-10,-10}},
        rotation=90,
        origin={178,16})));
  ...
  TRANSFORM.Fluid.Valves.ValveLinear LPT2_Bypass_2(
    redeclare package Medium = Modelica.Media.Water.StandardWater,
    dp_nominal=1000000,
    m_flow_nominal=data.valve_LPT2_Bypass_mflow) annotation (Placement(
        transformation(
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=1)
    annotation (Placement(transformation(extent={{190,-38},{170,-18}})));
...
equation
  ...
  connect(actuatorBus.Feed_Pump_Speed,FWCP. inputSignal) annotation (Line(
      points={{30,100},{258,100},{258,-130},{-34,-130},{-34,-65}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(Condenser.port_b, FWP.port_a) annotation (Line(
      points={{236,-112},{236,-120},{160,-120}},
      color={0,127,255},
      thickness=0.5));
  connect(FWP.port_b, volume1.port_a) annotation (Line(
      points={{140,-120},{122,-120},{122,-58},{84,-58}},
      color={0,127,255},
      thickness=0.5));
  ...
  connect(LPT2_Bypass_1.port_b, BypassFeedwaterHeater.Shell_in) annotation (
      Line(points={{178,6},{178,-16},{4,-16},{4,-52},{8,-52}}, color={0,127,255}));
  connect(BypassFeedwaterHeater.Shell_out, LPT2_Bypass_2.port_a)
    annotation (Line(points={{28,-52},{152,-52}}, color={0,127,255}));
  connect(realExpression.y, LPT2_Bypass_2.opening)
  ...
  connect(TBV.port_b, prt_b_steamdump)
    annotation (Line(points={{-82,72},{-140,72}}, color={0,127,255}));
  connect(sensor_m_flow.port_b, port_b_bypass) annotation (Line(points={{18,
          7.21645e-16},{-61,7.21645e-16},{-61,0},{-140,0}}, color={0,127,255}));
...
end SteamTurbine_L3_CloseFeedHeat_withPorts_v1;
