...
model CS_Rankine_Xe100_Based_Secondary_temp_for_3staged_turbine
  ...
  TRANSFORM.Controls.LimPID PI_IntTBV(
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
    k=5e-7,
    Ti=15,
    yMax=1.0,
...
equation
  ...
  connect(actuatorBus.opening_TCV, add1.y) annotation (Line(
      ...
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.massflow_LPTv, PI_IntTBV.u_m) annotation (Line(
      points={{-30,-100},{-82,-100},{-82,-96},{-122,-96},{-122,74},{-102,74},{
          -102,84},{-30,84},{-30,92}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(PI_IntTBV.u_s, const1.y)
    annotation (Line(points={{-42,104},{-42,106},{-73,106}}, color={0,0,127}));
  connect(actuatorBus.openingLPTv, PI_IntTBV.y) annotation (Line(
      points={{30,-100},{30,104},{-19,104}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
annotation(defaultComponentName="changeMe_CS", Icon(graphics));
end CS_Rankine_Xe100_Based_Secondary_temp_for_3staged_turbine;
