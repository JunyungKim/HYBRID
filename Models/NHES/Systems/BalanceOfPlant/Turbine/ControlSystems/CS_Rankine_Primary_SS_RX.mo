...
model CS_Rankine_Primary_SS_RX
  ...
  extends
    NHES.Systems.PrimaryHeatSystem.HTGR.HTGR_Rankine.BaseClasses.Partial_ControlSystem;
  ...
  replaceable NHES.Systems.PrimaryHeatSystem.HTGR.HTGR_Rankine.Data.Data_CS data(
