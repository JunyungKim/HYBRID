...
model CS
  ...
  Modelica.Blocks.Logical.Switch electricDemand
    annotation (Placement(transformation(extent={{-182,110},{-162,130}})));
  Modelica.Blocks.Sources.Trapezoid foPower(
    amplitude=-15e6,
    rising=7200,
    width=36000,
    falling=7200,
...
equation
  ...
  connect(soPower.y, electricDemand.u1) annotation (Line(points={{-201,150},{-190,
          150},{-190,128},{-184,128}}, color={0,0,127}));
  connect(electricDemand.y, LTV1_Divert_Valve1.u_s)
    annotation (Line(points={{-161,120},{-57.6,120}}, color={0,0,127}));
  connect(greater4.y, electricDemand.u2)
  ...
  connect(foPower.y, electricDemand.u3) annotation (Line(points={{-201,86},{
          -192,86},{-192,112},{-184,112}}, color={0,0,127}));
