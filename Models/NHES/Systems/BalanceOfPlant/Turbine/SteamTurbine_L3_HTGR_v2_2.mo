...
model SteamTurbine_L3_HTGR_v2_2
  ...
  Data.HTGR_3_BOP_Init dataInitial(
    BypassFeedHeater_shell_p_start=4500000,
    BypassFeedHeater_m_start_tube=55,
    LPT2_T_inlet=473.15)
  ...
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT boundary3(
    ...
    T=318.15,
    nPorts=1)
    annotation (Placement(transformation(extent={{208,-62},{188,-42}})));
  Fluid.HeatExchangers.Generic_HXs.NTU_HX_SinglePhase BypassFeedwaterHeater(
    ...
    T_start_tube_outlet=481.15,
    p_start_shell=4500000,
...
equation
  ...
  connect(LPT2_Bypass.port_b, boundary3.ports[1])
    annotation (Line(points={{174,-52},{188,-52}}, color={0,127,255}));
  connect(BypassFeedwaterHeater.Shell_out, LPT2_Bypass.port_a)
    annotation (Line(points={{28,-52},{154,-52}}, color={0,127,255}));
  connect(tee2.port_3, BypassFeedwaterHeater.Shell_in) annotation (Line(points=
          {{178,40},{162,40},{162,20},{114,20},{114,-38},{0,-38},{0,-52},{8,-52}},
        color={0,127,255}));
