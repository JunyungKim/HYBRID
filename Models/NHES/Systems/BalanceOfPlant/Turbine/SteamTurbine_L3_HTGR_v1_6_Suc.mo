...
model SteamTurbine_L3_HTGR_v1_6_Suc
  ...
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT boundary3(
    ...
    T=473.15,
    nPorts=1)
    annotation (Placement(transformation(extent={{194,-62},{174,-42}})));
...
equation
  ...
  connect(BypassFeedwaterHeater.Shell_out, boundary3.ports[1])
    annotation (Line(points={{28,-52},{174,-52}}, color={0,127,255}));
...
end SteamTurbine_L3_HTGR_v1_6_Suc;
