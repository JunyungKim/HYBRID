...
model SteamTurbine_L3_HTGR_v2_1_Suc
...
equation
  ...
  connect(LPT2_Bypass1.port_b, boundary3.ports[1])
    annotation (Line(points={{172,-52},{188,-52}}, color={0,127,255}));
...
end SteamTurbine_L3_HTGR_v2_1_Suc;
