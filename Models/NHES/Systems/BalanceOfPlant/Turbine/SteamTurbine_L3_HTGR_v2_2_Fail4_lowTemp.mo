...
model SteamTurbine_L3_HTGR_v2_2_Fail4_lowTemp
  extends BaseClasses.Partial_SubSystem(
    ...
    redeclare Data.HTGR_3_BOP   data(
      valve_LPT2_Bypass_mflow=15,
      BypassFeedHeater_V_tube=10,
      BypassFeedHeater_V_shell=10));
  Real time_altered;
...
equation
  ...
  connect(BypassFeedwaterHeater.Shell_out, R_InternalBypass.port_a)
    annotation (Line(points={{28,-52},{125,-52}}, color={0,127,255}));
  connect(R_InternalBypass.port_b, boundary3.ports[1])
    annotation (Line(points={{139,-52},{188,-52}}, color={0,127,255}));
...
end SteamTurbine_L3_HTGR_v2_2_Fail4_lowTemp;
