...
model SteamTurbine_L3_HPCFWH_v1
  ...
  Fluid.HeatExchangers.Generic_HXs.NTU_HX_SinglePhase BypassFeedwaterHeater(
    ...
    Q_init=2*dataInitial.BypassFeedHeater_Q_init,
  ...
  TRANSFORM.Fluid.Valves.ValveLinear LPT2_Bypass_2(
    redeclare package Medium = Modelica.Media.Water.StandardWater,
    dp_nominal=1000000,
    m_flow_nominal=20)                           annotation (Placement(
        transformation(
        extent={{5,5},{-5,-5}},
        rotation=180,
        origin={53,-15})));
  Modelica.Blocks.Sources.RealExpression realExpression(y=1)
    annotation (Placement(transformation(extent={{70,-10},{54,2}})));
  Data.HTGR_3_BOP_Init dataInitial
    annotation (Placement(transformation(extent={{68,120},{88,140}})));
equation
  connect(TBV.port_a, SteamHeader.port_b)
    annotation (Line(points={{-71,72},{-71,60},{-80,60}}, color={0,127,255}));
  ...
  connect(condenser.port_a, port_b_condensor) annotation (Line(points={{82.2,
          -47.8},{82.2,-42},{100,-42}},
                                    color={0,127,255}));
  ...
  connect(SteamHeader.port_b, HPT_bypass_valve.port_a) annotation (Line(
        points={{-80,60},{-74,60},{-74,-19},{-62,-19}},
        color={0,127,255}));
  ...
  connect(realExpression.y, LPT2_Bypass_2.opening)
    annotation (Line(points={{53.2,-4},{53,-4},{53,-11}}, color={0,0,127}));
  connect(LPT2_Bypass_2.port_b, Mixer.port_b[2]) annotation (Line(points={{58,
          -15},{58,-14},{82.875,-14},{82.875,-16}}, color={0,127,255}));
  connect(BypassFeedwaterHeater.Shell_out, LPT2_Bypass_2.port_a) annotation (
      Line(points={{-18,-54},{44,-54},{44,-15},{48,-15}}, color={0,127,255}));
