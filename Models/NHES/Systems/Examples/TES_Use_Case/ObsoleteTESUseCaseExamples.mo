  ...
  model SMR_SHS_Test_Config_Peaking_ImpControl_3
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    EnergyManifold.SteamManifold.SteamManifold_L1_boundaries EM(port_a1_nominal(
      ...
      nPorts_b3=1)
      annotation (Placement(transformation(extent={{-12,-18},{28,22}})));
    BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC_3_Peaking_IC_3
      intermediate_Rankine_Cycle_TESUC(
      port_a_nominal(
        p=EM.port_b2_nominal.p,
        h=EM.port_b2_nominal.h,
  ...
  model SMR_SHS_Test_Config_Independent
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    EnergyManifold.SteamManifold.SteamManifold_L1_boundaries EM(port_a1_nominal(
      ...
      nPorts_b3=1)
      annotation (Placement(transformation(extent={{-12,-18},{28,22}})));
    BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC_1_Independent
      intermediate_Rankine_Cycle_TESUC(
      port_a_nominal(
        p=EM.port_b2_nominal.p,
        h=EM.port_b2_nominal.h,
  ...
  model SMR_SHS_Test_Config_Peaking_ImpControl_2
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    EnergyManifold.SteamManifold.SteamManifold_L1_boundaries EM(port_a1_nominal(
      ...
      nPorts_b3=1)
      annotation (Placement(transformation(extent={{-12,-18},{28,22}})));
    BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC_3_Peaking_IC_2
      intermediate_Rankine_Cycle_TESUC(
      port_a_nominal(
        p=EM.port_b2_nominal.p,
        h=EM.port_b2_nominal.h,
  ...
  model SMR_SHS_Test_Config_Peaking_ImpControl
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    EnergyManifold.SteamManifold.SteamManifold_L1_boundaries EM(port_a1_nominal(
      ...
      nPorts_b3=1)
      annotation (Placement(transformation(extent={{-12,-18},{28,22}})));
    BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC_3_Peaking_IC
      intermediate_Rankine_Cycle_TESUC(
      port_a_nominal(
        p=EM.port_b2_nominal.p,
        h=EM.port_b2_nominal.h,
  ...
  model SMR_SHS_Test_Config_Peaking_TempControl
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    EnergyManifold.SteamManifold.SteamManifold_L1_boundaries EM(port_a1_nominal(
      ...
      nPorts_b3=1)
      annotation (Placement(transformation(extent={{-12,-18},{28,22}})));
    BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC_3_Peaking
      intermediate_Rankine_Cycle_TESUC(
      port_a_nominal(
        p=EM.port_b2_nominal.p,
        h=EM.port_b2_nominal.h,
  ...
  model SMR_SHS_Test_6
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    EnergyManifold.SteamManifold.SteamManifold_L1_boundaries EM(port_a1_nominal(
      ...
      nPorts_b3=1)
      annotation (Placement(transformation(extent={{-12,-18},{28,22}})));
    BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC_2
      intermediate_Rankine_Cycle_TESUC(
      port_a_nominal(
        p=EM.port_b2_nominal.p,
        h=EM.port_b2_nominal.h,
    ...
    TRANSFORM.Fluid.Valves.ValveLinear SHS_Throttle(
      ...
      m_flow_nominal=30) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={50,-30})));
    BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC_SmallCycle_Pressure
...
<p>System is based upon report: Frick, Konor L. Status Report on the NuScale Module Developed in the Modelica Framework. United States: N. p., 2019. Web. doi:10.2172/1569288.</p>
  ...
  model SMR_SHS_Test_4_NewSHS_NewCS
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    BalanceOfPlant.RankineCycle.ObsoleteRankines.SteamTurbine_L1_boundaries_no_heat
      BOP1(
      port_a_nominal(
        p=1200000,
        h=2e6,
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    TRANSFORM.Fluid.Valves.ValveLinear SHS_Throttle(
      ...
      m_flow_nominal=30) annotation (Placement(transformation(
          ...
          rotation=180,
          origin={50,-30})));
    BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC_SmallCycle
      intermediate_Rankine_Cycle_TESUC_SmallCycle(
      port_a_nominal(
        p=1200000,
        h=2e6,
...
<p>System is based upon report: Frick, Konor L. Status Report on the NuScale Module Developed in the Modelica Framework. United States: N. p., 2019. Web. doi:10.2172/1569288.</p>
  ...
  model SMR_highfidelity_Intermediate_TESUC
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    BalanceOfPlant.RankineCycle.ObsoleteRankines.Intermediate_Rankine_Cycle_TESUC
      intermediate_Rankine_Cycle_TESUC(
      port_a_nominal(
        p=EM.port_b2_nominal.p,
        h=EM.port_b2_nominal.h,
...
<p>System is based upon report: Frick, Konor L. Status Report on the NuScale Module Developed in the Modelica Framework. United States: N. p., 2019. Web. doi:10.2172/1569288.</p>
  ...
  model HTGR_Case_01_IndependentBOP_2
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    Modelica.Blocks.Math.Sum sum1
      annotation (Placement(transformation(extent={{134,102},{154,122}})));
    PrimaryHeatSystem.HTGR.RankineCycle.Models.HTGR_PebbleBed_Primary_Loop
  ...
  model HTGR_Case_01_IndependentBOP_Old
   ...
   max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
    ...
    EnergyManifold.SteamManifold.SteamManifold_L1_boundaries EM(
      ...
      nPorts_b3=1)
      annotation (Placement(transformation(extent={{-12,-18},{28,22}})));
    BalanceOfPlant.RankineCycle.HTGR_RankineCycles.SteamTurbine_OpenFeedHeat_DivertPowerControl_HTGR
      intermediate_Rankine_Cycle_TESUC(
      redeclare replaceable
        NHES.Systems.BalanceOfPlant.RankineCycle.Data.TESTurbine data(
        p_in_nominal=15000000,
