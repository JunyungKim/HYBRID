...
model HTGR_Case_03_OversizedTurbine
 ...
 max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
  ...
  BalanceOfPlant.RankineCycle.HTGR_RankineCycles.SteamTurbine_OpenFeedHeat_DivertPowerControl_PowerBoostLoop_HTGR
  ...
  PrimaryHeatSystem.HTGR.RankineCycle.Models.HTGR_PebbleBed_Primary_Loop_TESUC
