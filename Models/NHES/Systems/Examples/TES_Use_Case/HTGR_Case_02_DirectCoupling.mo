...
model HTGR_Case_02_DirectCoupling
 ...
 parameter String fileName=Modelica.Utilities.Files.loadResource(
  ...
  PrimaryHeatSystem.HTGR.RankineCycle.Models.HTGR_PebbleBed_Primary_Loop_TESUC_Direct
  ...
  BalanceOfPlant.RankineCycle.HTGR_RankineCycles.SteamTurbine_Basic_DirectCoupling_HTGR
