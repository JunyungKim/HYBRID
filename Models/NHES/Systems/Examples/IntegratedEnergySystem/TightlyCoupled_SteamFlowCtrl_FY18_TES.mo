...
model TightlyCoupled_SteamFlowCtrl_FY18_TES
 ...
 parameter Real fracNominal_Other = sum(abs(EM.port_b3_nominal_m_flow))/EM.port_a1_nominal.m_flow;
  ...
  extends BaseClasses.PartialExample_A(
    redeclare PrimaryHeatSystem.FourLoopPWR.Models.NSSS PHS(redeclare
        NHES.Systems.PrimaryHeatSystem.FourLoopPWR.ControlSystems.CS_SteadyNominalPower
        CS(delayStart_SGpump=500, delayStart_CR=200)),
