...
model SMR_Test_3ST_OFWH
  extends Modelica.Icons.Example;

  BalanceOfPlant.RankineCycle.Models.SteamTurbine_L3_HPOFWH BOP(
    redeclare replaceable
      NHES.Systems.BalanceOfPlant.RankineCycle.ControlSystems.CS_L3_SMR CS(data(
        Power_nom=80e6,
        HPT_p_in=3450000,
        Tin=579.25,
        Tfeed=421.15,
