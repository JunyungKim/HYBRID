within NHES.Systems.PrimaryHeatSystem.FourLoopPWR.Models;
model NSSS
  import TRANSFORM;
  extends BaseClasses.Partial_SubSystem_A(
    replaceable package Medium = Modelica.Media.Water.StandardWater,
    allowFlowReversal=system.allowFlowReversal,
    redeclare replaceable ControlSystems.CS_Default CS,
    redeclare replaceable ControlSystems.ED_Default ED,
    port_a_nominal(
      p=data.p_shellSide,
