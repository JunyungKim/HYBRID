...
model Rankine_HTGR_ThreeStageTurbine_CFWH
  ...
  BalanceOfPlant.Turbine.SteamTurbine_L3_CloseFeedHeat_withPorts_v1
      ...
      CS) annotation (Placement(transformation(extent={{14,-10},{82,38}})));
...
equation
  ...
  connect(sinkElec.port, BOP.port_e)
    annotation (Line(points={{86,14},{82,14}}, color={255,0,0}));
  ...
  connect(stateSensor1.port_b, BOP.port_a)
    annotation (Line(points={{-14,26},{14,26},{14,25.52}}, color={0,127,255}));
  connect(stateSensor2.port_a, BOP.port_b)
    annotation (Line(points={{-14,0},{14,0.08}}, color={0,127,255}));
  ...
  connect(BOP.port_b_bypass, bypassdump.ports[1]) annotation (Line(points={{14,
          14},{12,14},{12,-56},{6,-56}}, color={0,127,255}));
  connect(steamdump.ports[1], BOP.prt_b_steamdump) annotation (Line(points={{6,
          82},{10,82},{10,31.28},{14,31.28}}, color={0,127,255}));
...
end Rankine_HTGR_ThreeStageTurbine_CFWH;
