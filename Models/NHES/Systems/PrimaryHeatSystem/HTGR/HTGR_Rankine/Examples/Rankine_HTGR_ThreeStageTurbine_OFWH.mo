...
<<<<<<< HEAD
    annotation (Line(points={{34,13},{36,13},{36,10},{40,10}},
                                               color={0,127,255}));
=======
...
<<<<<<< HEAD
  ...
  connect(bypassdump.ports[2], BOP.port_b_bypass) annotation (Line(points={{34,15},
          {36,15},{36,10},{40,10}},     color={0,127,255}));
=======
