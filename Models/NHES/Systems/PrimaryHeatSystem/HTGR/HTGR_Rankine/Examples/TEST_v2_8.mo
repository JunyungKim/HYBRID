...
model TEST_v2_8
  ...
  BalanceOfPlant.Turbine.SteamTurbine_L3_HTGR_v2_8_ISeeHope BOP(
    redeclare
      NHES.Systems.BalanceOfPlant.Turbine.ControlSystems.CS_threeStagedTurbine_HTGR_v3
      CS,
    LPT2_Bypass1(dp_nominal=100000),
    LPT2_Bypass(dp_nominal=100000),
    TCV(dp_nominal(displayUnit="Pa") = 1))
