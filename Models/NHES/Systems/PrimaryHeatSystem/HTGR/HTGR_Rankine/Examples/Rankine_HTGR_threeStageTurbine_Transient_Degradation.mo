...
equation
  hTGR_PebbleBed_Primary_Loop.input_steam_pressure =
    hTGR_Rankine_Cycle_Transient_JY_v1_step10_TCV_Control_PumpDegradation_type6_1.sensor_p.p;
  Thermal_Power_Norm = hTGR_PebbleBed_Primary_Loop.Thermal_Power.y/2.26177E8;
  connect(sinkElec.port,
    hTGR_Rankine_Cycle_Transient_JY_v1_step10_TCV_Control_PumpDegradation_type6_1.port_e)
  ...
  connect(stateSensor1.port_b,
    hTGR_Rankine_Cycle_Transient_JY_v1_step10_TCV_Control_PumpDegradation_type6_1.port_a)
    annotation (Line(points={{-14,26},{-6,26},{-6,25.52}}, color={0,127,255}));
  connect(stateSensor2.port_a,
    hTGR_Rankine_Cycle_Transient_JY_v1_step10_TCV_Control_PumpDegradation_type6_1.port_b)
