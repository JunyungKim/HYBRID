...
model SteamTurbine_L1_HTGR_v4_16sec
  import NHES;
  ...
  NHES.Systems.BalanceOfPlant.Turbine.SteamTurbine_L1_boundaries_type2 BOP(
    ...
    port_b_nominal(p=1000000, h=BOP.Medium.specificEnthalpy_pT(BOP.port_b_nominal.p,
          318.95)),
    redeclare
      NHES.Systems.BalanceOfPlant.Turbine.ControlSystems.CS_PressureAndPowerControl_HTGRcoupled_v2
      CS(
      p_nominal=14000000,
...
end SteamTurbine_L1_HTGR_v4_16sec;
