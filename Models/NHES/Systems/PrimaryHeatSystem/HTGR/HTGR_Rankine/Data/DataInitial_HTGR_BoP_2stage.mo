...
record DataInitial_HTGR_BoP_2stage
...
parameter SI.Temperature HPT_T_outlet = 253.77 + 273.15 annotation (Evaluate=true, Dialog(group="HPT_conditions"));
  ...
  // LPT Boundary conditions
parameter SI.Pressure LPT_P_inlet =     4.0562e5 annotation (Evaluate=true, Dialog(group="LPT_conditions"));
parameter SI.Pressure LPT_P_outlet =    0.0080e5 annotation (Evaluate=true, Dialog(group="LPT_conditions"));
parameter SI.Temperature LPT_T_inlet =  253.77 + 273.15 annotation (Evaluate=true, Dialog(group="LPT_conditions"));
parameter SI.Temperature LPT_T_outlet =  41.52 + 273.15 annotation (Evaluate=true, Dialog(group="LPT_conditions"));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
          ...
          textString="BOP_2stage")}),                            Diagram(
        coordinateSystem(preserveAspectRatio=false)));
end DataInitial_HTGR_BoP_2stage;
